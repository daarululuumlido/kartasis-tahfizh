...
//AdmobId
const adMobBannerId = "ADD YOUR FACEBOOK BANNER ID";
const adMobInterstitialId = "ADD YOUR FACEBOOK BANNER ID";
const adMobBannerIdIos = "ADD YOUR FACEBOOK BANNER ID";
const adMobInterstitialIdIos = "ADD YOUR FACEBOOK BANNER ID";

// Facebook
const FACEBOOK_KEY = 'ADD YOUR FACEBOOK_KEY';
